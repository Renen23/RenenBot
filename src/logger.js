...
export function successLog(message) {
  console.log("\x1b[32m[RENEN BOT | SUCESSO]\x1b[0m", message);
}

export function warningLog(message) {
  console.log("\x1b[33m[RENEN BOT | ATENCAO]\x1b[0m", message);
}

export function errorLog(message) {
  console.log("\x1b[31m[RENEN BOT | ERRO]\x1b[0m", message);
}
